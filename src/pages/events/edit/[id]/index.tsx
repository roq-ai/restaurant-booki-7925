      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="venue" mb="4" isInvalid={!!formik.errors?.venue}>
              <FormLabel>Venue</FormLabel>
              <Input type="text" name="venue" value={formik.values?.venue} onChange={formik.handleChange} />
              {formik.errors.venue && <FormErrorMessage>{formik.errors?.venue}</FormErrorMessage>}
            </FormControl>
